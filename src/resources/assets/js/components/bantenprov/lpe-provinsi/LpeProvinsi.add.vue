      ...
      <div class="col-md-8 col-lg-9 admin-main">
        ...
        <div class="col-md-12">
          <div class="card mb-3">
            ...
            <div class="card-body">
            <b-card header="Tambah lPE Provinsi" header-tag="h4" class="bg-success-card">
...
export default {
    ...
    methods: {
              ...
              if(this.model.tahun >= 2000 && this.model.tahun <= (new Date()).getFullYear())
              {
                ...
                .then(response => {
                  if(response.data.type == 'success'){
                    ...
                    window.location.href = '#/admin/lpe-provinsi/'+response.data.id
                  }
                  else{
                    miniToastr.error(response.data.message, response.data.title)
                    window.location.href = '#/admin/lpe-provinsi/create'
                  }
                },
                window.location.href = '#/admin/lpe-provinsi/create')
        ...
        back() {
            window.location = '#/admin/lpe-provinsi';
        }
    },
    mounted: function() {
        axios.get("/lpe-provinsi/create").then(response => {
